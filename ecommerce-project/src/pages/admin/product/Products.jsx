...
import { Edit, Images, ImagesIcon, ImageUp, MoreHorizontal, MoreHorizontalIcon, Upload } from "lucide-react";
        ...
        <table className="min-w-full">
          <thead className="bg-orange-500 text-white">
            <tr>
              ...
              <th className="px-6 py-4 text-left">PD-Details</th>
            </tr>
          </thead>
          ...
          <tbody>
            {products && products.map((product) => (
              ...
              >
                ...
                <td className="px-6 py-4 text-gray-300">{product.productDetailId}</td>
                ...
                <td className="px-6 py-4 text-gray-300">
                  <Link  to={`/admin/products/prod-id-/${product.id}`}>
                   ...
                   <td className="px-6 py-4 text-gray-300">
                  <Link  to={`/admin/products/prod-details/${product.productDetailId}`}>
                    <MoreHorizontalIcon/>
                  </Link>
                </td>
              </tr>
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
               ...
               <div className="flex justify-between">
                ...
                <span className="text-white">{product.productDetailId}</span>
              </div>
              ...
              <div className="flex justify-between">
               ...
               <td className="px-6 py-4 text-gray-300">
                ...
                <td className="px-6 py-4 text-gray-300">
                <span className="text-gray-400">PD-Details</span>
                  <Link to={`/admin/products/prod-details/${product.productDetailId}`}>
                    <MoreHorizontalIcon />
                  </Link>
                </td>
